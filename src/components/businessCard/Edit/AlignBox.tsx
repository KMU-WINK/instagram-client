	...
	return (
		<>
			<BoxContainer style={{ height: "80px" }}>
				<Title content={"정렬"} />
				<InnerContainer>
					<AlignImg src={alignCenter} id={"center"} state={selected[0].state} onClick={handleOnClick} />
					<AlignImg src={alignLeft} id={"left"} state={selected[1].state} onClick={handleOnClick} />
					<AlignImg src={alignRight} id={"right"} state={selected[2].state} onClick={handleOnClick} />
					<AlignImg src={justify} id={"justify"} state={selected[3].state} onClick={handleOnClick} />
				</InnerContainer>
			</BoxContainer>
		</>
	);

...
// @ts-ignore
import SubBusinessCardImg from "../../../img/SubBusinessCardImg.png";
// @ts-ignore
...
export default function FirstSubCard() {
	const name = "_2soh";
	...
	return (
		<>
			<CardContainer onClick={() => navigate("/businesscard/subcard")} className={"first"}>
				<CardBorder>
					<ImageContainer>
						<Image src={SubBusinessCardImg} />
					</ImageContainer>
					<CenterContainer>
						<Name>{name}</Name>
